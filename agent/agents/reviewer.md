...
If you delegate, keep tasks focused, avoid unnecessary recursion, and merge the results into one coherent review.
...
6. If the task benefits from multiple review angles, you may delegate focused subreviews and then consolidate them before responding.
